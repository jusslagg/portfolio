...
export default function Portfolio() {
  ...
  // Actualizar el array de certificados con los links reales:
  ...
  const skills = [
    ...
    { name: "JavaScript", level: 92, color: "bg-gradient-to-r from-yellow-500 to-orange-600", icon: "🟨" },
    { name: "TypeScript", level: 85, color: "bg-gradient-to-r from-blue-600 to-indigo-700", icon: "📘" },
    ...
    { name: "IA", level: 85, color: "bg-gradient-to-r from-purple-500 to-pink-600", icon: "🤖" },
        ...
        <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          >
            ...
            <div className="flex justify-center gap-4 mb-12 flex-wrap">
              ...
              >
                <a href="https://drive.google.com/file/d/1nmV2MRGgrWC59lpwN9wf5ZX70ua2cfO8/view?usp=sharing" target="_blank" rel="noreferrer">
              ...
              <div className="flex items-center justify-center">
                ...
                <div className="flex gap-6 overflow-hidden max-w-6xl">
                  {[-2, -1, 0, 1, 2].map((offset) => {
                    ...
                    return (
                      // En la sección de certificados, actualizar el Card para que sea clickeable:
                      ...
                      >
                        <CardContent className="p-0">
                          <div
                            className={`h-60 bg-gradient-to-br ${cert.color} p-8 text-white relative overflow-hidden group`}
                          >
                            ...
                            <div className="absolute top-4 left-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform -translate-y-2 group-hover:translate-y-0">
                              <div className="bg-white/20 backdrop-blur-sm rounded-full p-2 flex items-center gap-2 text-sm font-medium">
                            ...
                            <div className="relative z-10">
                              <h3 className="text-2xl font-bold mb-3 leading-tight group-hover:scale-105 transition-transform">
                                {cert.name}
                              </h3>
